...
import { BarChart3, MapPin, MessageCircle, RefreshCw, Trash2, Users } from 'lucide-react';
    ...
    const handleDeleteUser = async (userId: string) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setComments(comments.filter(comment => comment.profiles.id !== userId));
        ...
        <div className="container mx-auto p-6">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage users, pins, and comments</p>
                </div>
